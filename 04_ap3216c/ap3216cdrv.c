...
static const struct of_device_id of_match_ids_ap3216c[] = {
	{ .compatible = "r5ett,ap3216c",		.data = NULL },
	{ /* END OF LIST */ },
};

static const struct i2c_device_id ap3216c_ids[] = {
	{ "r5ett_ap3216c",	(kernel_ulong_t)NULL },
	{ /* END OF LIST */ }
};
...
static int ap3216c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	/* register_chrdev */
	major = register_chrdev(0, "r5ett_ap3216c", &ap3216c_ops);

	ap3216c_class = class_create(THIS_MODULE, "r5ett_ap3216c_class");
	device_create(ap3216c_class, NULL, MKDEV(major, 0), NULL, "r5ett_ap3216c"); /* /dev/ap3216c */
...
static int ap3216c_remove(struct i2c_client *client)
{
	...
	/* unregister_chrdev */
	unregister_chrdev(major, "r5ett_ap3216c");
